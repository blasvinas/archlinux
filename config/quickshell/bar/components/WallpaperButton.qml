...
// Bar button that opens the wallpaper picker.
Item {
    id: root
    ...
    Text {
        ...
        text: String.fromCodePoint(0xF021F) // image
    ...
    MouseArea {
        ...
        onClicked: if (Svc.Overlays.wallpaperPicker) Svc.Overlays.wallpaperPicker.toggle()
    }
}
